...
class EditorsTools extends React.Component {
    ...
    render() {
        return (
            <>
                <div className={"w-full border-y-2 rounded-2xl mb-8 flex justify-center items-center"}>
                    <a href={`${window.location.pathname}/edit`}>
                    ...
                    <svg onClick={() => {
                        if(window.confirm("This will revert story to draft and will not be publicly visible. Are you sure you want to continue?")) return this.props.action('patch')
