                ...
                <div id={"navigation"}
                    ...
                    <div className={"w-full md:w-10/12 m-auto flex items-center"}>
                        ...
                        <div className={"ml-auto flex items-center"}>
                            <ul id={"nav-actions"} className={"block md:hidden items-center"}>
                                {
                                    this.props.submit && <li>
                                        <svg onClick={this.props.handleSubmit} xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mx-4"
                                             fill="none" viewBox="0 0 24 24" stroke="green">
...

                                {
                                    ...
                                    !this.props.popState &&
                                    <li>
                                        <svg onClick={this.props.showPop} xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mx-4"
                                             fill="none" viewBox="0 0 24 24" stroke="green">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                                                  d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                        </svg>
                            ...
                            <Menu as={"div"} id={"side-nav"} className={"md:hidden"}>
                                <Menu.Button as={"div"}>
